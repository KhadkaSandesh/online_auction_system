...
<body>
	...
	<div class="header">
		...
		<div class="search-bar">
			...
			<!-- <input class="search-query"type="text" name="search_query">  -->
			</div>
			<div>
				 <input type="submit" style="visibility: hidden; display: none;">
				
			</div>
			<!-- <i style="margin-left: 55px; margin-top: 12px; cursor: pointer;" class="fa fa-search"></i> -->
		...
		<div class="right-account">
			<a href="../user/login.php"><button class="btn_login">LOGIN</button></a>
			<a href="../user/signup.php"><button class="btn_signup">SIGNUP</button></a>
	...
	<div class="products">
		...
		<div class="categories">
			<div class="cat_item">
				...
				<a href="../welcome/products.php?category=real_estate"><img src="../images/real_estate1.jpeg" height="160px" width="160px"></a>
				<h3>Real Estate</h3>
			</div>
			<div class="cat_item">
				
				<a href="../welcome/products.php?category=electronics"><img src="../images/electronics.jpg" height="160px" width="160px"></a>
				<h3>Electronics</h3>
			</div>
			<div class="cat_item">
				
				<a href="../welcome/products.php?category=furnitures"><img src="../images/furnitures.jpg" height="160px" width="160px"></a>
				<h3>Furnitures</h3>
			</div>
			<div class="cat_item">
				
				<a href="../welcome/products.php?category=clothing"><img src="../images/clothing.jpg" height="160px" width="160px"></a>
				<h3>Clothing</h3>
			</div>
			<div class="cat_item">
				
				<a href="../welcome/products.php?category=motors"><img src="../images/motors.jpg" height="160px" width="160px"></a>
				<h3>Motors and Tools</h3>
			</div>
			<div class="cat_item">
				
				<a href="../welcome/products.php?category=video_games"><img src="../images/video_games.webp" height="160px" width="160px" style="border:none;"></a>
